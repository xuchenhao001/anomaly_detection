...
def args_parser():
    ...
    parser.add_argument('--dataset_size', type=int, default=400000, help="total used dataset size for all nodes")
    ...
    parser.add_argument('--start_sleep', type=int, default=0, help="sleep for seconds before start train")
